...
namespace MemcardRex.macOS
{
	public partial class HardwareDialogController : NSViewController
	{
        ...
        {
            if (_hardInterface.Type == HardwareInterface.Types.unirom && _hardInterface.CommMode == (int)HardwareInterface.CommModes.read)
            {
        ...
        private void BackgroundWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            while (i < _hardInterface.FrameCount)
            {
                ...
                else
                {
                    ...
                    if (HardInterface.Type == HardwareInterface.Types.unirom)
                    {
                        frameSize = 2048;
